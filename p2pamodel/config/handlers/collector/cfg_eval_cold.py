...
config = ConfigBase('Config for two source: DEfT, JEDI')
...
deft_src.query.conditions = COMMON_QUERY_CONDITIONS + [
    "ttcr_timestamp is not null",
    "ttcj_timestamp is not null"
]
...
jedi_src.query.time_range_column = 'creationdate'
