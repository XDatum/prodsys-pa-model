...
#krenew -K 5 -b
aklog
ssh -o GSSAPIAuthentication=yes -o GSSAPIDelegateCredentials=yes ${SERVICE_EXEC_USER}@${ANALYTICS_CLUSTER} "source ${P2PA_REMOTE_ENV}; export PYTHONPATH=${PYTHONPATH}:${P2PA_EXEC_DIR}; ${P2PA_EXEC_MODULE}"
kdestroy
